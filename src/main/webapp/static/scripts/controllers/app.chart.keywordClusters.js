(function () {
    'use strict';
    angular.module('app.keywordClusters', [])
            .controller('KeywordClustersController', ['$scope', function ($scope) {
// HELPERS                
                    ...
                    d3.csv('datas/keywordCluster.csv', function (data) {

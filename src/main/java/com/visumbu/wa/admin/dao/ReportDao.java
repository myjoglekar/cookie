...
public class ReportDao extends BaseDao {
    ...
    public Map getVisitDetailsList(Date startDate, Date endDate, ReportPage page,
        ...
        String queryStr = "select os, browser, url, device_type deviceType, resolution, timeZone, d.dealer_name dealerName, "
                ...
                + " case when referrer_type is not null then referrer_type else (select referrer_type from visit_log where visit_id=v.visit_id and referrer_domain not like domain_name order by visit_time limit 1) referrerType, "

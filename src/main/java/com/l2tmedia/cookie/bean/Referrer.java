...
public class Referrer {
    ...
    private static final String[] PAID_ARRAY = {"utm_source", "utm_medium", "utm_term", "utm_content", "utm_id", "utm_campaign", "gclid", "aclk", "utm_medium=cpc", "utm_medium=ppc", "utm_medium=paid search", "channel=paid", "channel=paidsearch", "channel=cpc", "utm_medium=email", "utm_medium=banner", "utm_medium=paid"};

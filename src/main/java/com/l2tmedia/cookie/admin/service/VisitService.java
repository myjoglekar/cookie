...
public class VisitService {
    ...
    public Dealer read(Integer id) {
        logger.debug("Calling a function get user details for the id " + id);
        return (Dealer) visitDao.read(Dealer.class, id);
    }

    public List<Dealer> read() {
        logger.debug("Calling a function to list all users");
    ...
    public Conversion saveConversion(VisitInputBean visitBean, Dealer dealer) {
        logger.debug("Calling function of save conversion for the dealer " + dealer.getDealerName());
    ...
    public ActionLog saveAction(VisitInputBean visitBean, Dealer dealer) {
        logger.debug("Calling a function to saveAction for the delaer" + dealer);
    ...
    public VisitLog saveLog(VisitInputBean visitBean, Dealer dealer) {
        logger.debug("Calling a function to save log details for the dealer " + dealer);
    ...
    public Dealer updateDealerDetails(VisitInputBean visitBean) {
        logger.debug("Calling a function of updateDealerDetails for a dealer" + visitBean);
    ...
    public void saveVisitProperties(Properties supportedPlugins, VisitLog visitLog) {
        logger.debug("Calling a function to save visit properties for the visit log " + visitLog);
    ...
    public UniqueVisit updateUniqueVisitDetails(VisitLog visitLog) {
        logger.debug("Calling a function of update unique visit details for the visit log="+visitLog);
    ...
    public String getReferrerUrl(String visitId, Integer visitCount) {
        logger.debug("Calling a function of get referrer url for the visit id=" +visitId+" and visit count" + visitCount);
        return visitDao.getReferrerUrl(visitId, visitCount);
    }

    private Boolean isValidConversion(Conversion conversion) {
        logger.debug("Calling a function of check it's a valid conversion for the conversion " + conversion);

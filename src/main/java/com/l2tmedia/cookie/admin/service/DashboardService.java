...
public class DashboardService {
    ...
    public List<DealerVisitBean> getTopDealersByVisit(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getTopDealersByVisit for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List hourlyVisitChart(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function hourlyVisitChart for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List getDashboardTickers(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getDashboardTickers for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List<DeviceTypeBean> getByDeviceType(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByDeviceType for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List<VisitGeoReportBean> getByGeoReport(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByGeoReport for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List getByBrowser(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByBrowser for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List getByOs(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByOs for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List<ReferrerBean> getByReferrer(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByReferrer for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List<ReferrerPageBean> getByReferrerPage(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByReferrerPage for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List getByMonthlyForSixMonths(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByMonthlyForSixMonths for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);        
    ...
    public List getByDaily(Date startDate, Date endDate, Integer dealerSiteId) {
        logger.debug("Calling function getByDaily for a specific dealerSiteId where date range between startDate="+startDate+"and endDate="+endDate);
